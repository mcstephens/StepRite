 ...
 * @category	XML-RPC
 * @author		ExpressionEngine Dev Team
 * @link		http://steprite.com/user_guide/libraries/xmlrpc.html
 */
class StepRite_Xmlrpc {
	...
	var $xmlrpcName			= 'XML-RPC for steprite';
 ...
 * @link		http://steprite.com/user_guide/libraries/xmlrpc.html
 */
class XML_RPC_Client extends StepRite_Xmlrpc
{
	var $path			= '';
	var $server			= '';
	var $port			= 80;
 ...
 * @link		http://steprite.com/user_guide/libraries/xmlrpc.html
 */
class XML_RPC_Message extends StepRite_Xmlrpc
{
	var $payload;
	var $method_name;
	var $params			= array();
 ...
 * @link		http://steprite.com/user_guide/libraries/xmlrpc.html
 */
class XML_RPC_Values extends StepRite_Xmlrpc
{
	var $me		= array();
	var $mytype	= 0;
