 ...
 */
class StepRite_DB_cubrid_driver extends StepRite_DB {
	 ...
	 * file by setting the CStepRite_PCONNECT parameter to ON. In that case, all
	 ...
	 * considering that the CStepRite_PCONNECT is ON.
	 *
	 * @access	private called by the base class
	 * @return	resource
	 */
